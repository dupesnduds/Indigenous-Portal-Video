		...
		if (failed)
		{
			...
			UIAlertView *alert =
				[[UIAlertView alloc]
					...
					message:NSLocalizedStringFromTable(@"There is a problem with the audio file. Try another.", @"Errors", nil)
					delegate:self
			...
			NSAlert *alert =
				[NSAlert
					...
					alternateButton:nil
					otherButton:nil
					informativeTextWithFormat:@"There is a problem with the audio file. Try another."];
			[alert
